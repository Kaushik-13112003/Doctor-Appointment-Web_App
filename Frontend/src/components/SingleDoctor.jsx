...
const SingleDoctor = () => {
  ...
  return (
    <>
      ...
      <div className="flex gap-6 sm:flex-row flex-col sm:items-start  items-center">
        ...
        <div className="flex  gap-5 flex-col">
          ...
          <div>
            ...
            <p className="text-yellow-700">choose slots comfortable to you</p>
            ...
            <div className="flex items-center gap-3 mt-8 mb-5">
              <div className=" grid md:grid-cols-4 grid-cols-3 gap-3">
                {singleDoctorData?.availability?.map((ele) => {
                  return (
                    <button
                      className={`btn text-center gap-5  w-[100px]   bg-cyan-800 text-white p-2 rounded-md hover:bg-cyan-500 duration-500 cursor-pointer  ${
                        ele.day === selectDay ? "bg-cyan-600" : ""
                      }`}
                      onClick={(e) => {
                    ...
                    return slotTime.slots.map((time) => {
                      return (
                        <button
                          ...
                          className={`text-center gap-5 bg-cyan-800 text-white p-2 rounded-md  ${
                            time.time === selectTime
                              ? "bg-cyan-600 hover:bg-cyan-800 duration-500 cursor-pointer"
                              : ""
